...
ar9003_set_txdesc(struct ath_hw *ah, void *ds, struct ath_tx_info *i)
{
	...
	WRITE_ONCE(ads->ctl20, SM(i->txpower, AR_XmitPower1));
	WRITE_ONCE(ads->ctl21, SM(i->txpower, AR_XmitPower2));
	WRITE_ONCE(ads->ctl22, SM(i->txpower, AR_XmitPower3));
}
