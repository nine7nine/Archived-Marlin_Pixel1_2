...
static int _set_stune_boost(struct schedtune *st, int boost, int *slot)
{
	int ret = 0;
...
int set_stune_boost(char *st_name, int boost, int *slot)
{
	struct schedtune *st = getSchedtune(st_name);
	...
	return _set_stune_boost(st, boost, slot);
}
